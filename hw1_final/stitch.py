...
def task1():
    ...
    # SECOND CALIBRATION METHOD BY USING ONLY ONE MARKER (REUSING THE SAME IMAGE SIX TIMES)
    def calibrate_camera_one_marker():
        ...
        for img in calibration_images:
            ...
            for corner in corners:
                img_points2.append(corner.reshape(4, 2))  # Każdy marker ma 4 rogi
    ...
    for i, img in enumerate(stitching_images):
        undistorted_stitching_image = undistort_image(img, cameraMatrix, distCoeffs)
        # comparasion = np.hstack((img, undistorted_stitching_image))
        # cv2.imshow("Distorted vs Undistorted", comparasion)
        # # cv2.imshow("Distorted vs Undistorted", undistorted_stitching_image)
        # cv2.waitKey(0)
        # cv2.destroyAllWindows()
        cv2.imwrite(f"./stitching/undistorted_img{i+1}.png", undistorted_stitching_image)
...
def task2():
    ...
    src_img = cv2.imread(f"./stitching/undistorted_img1.png")
...
def task4():
    # PHOTOS TO STITCH
    src_img = cv2.imread(f"./stitching/undistorted_img1.png")
    dst_img = cv2.imread(f"./stitching/undistorted_img2.png")
...
def task6():
    # PHOTOS TO STITCH
    dst_img6 = cv2.imread(f"./stitching/undistorted_img8.png")
    src_img6 = cv2.imread(f"./stitching/undistorted_img9.png")
...
def task7():
    ...
    dst_img = cv2.imread(f"./stitching/undistorted_img3.png")

    src_img1 = cv2.imread(f"./stitching/undistorted_img1.png")
    path_matches13 = './matches/undistorted_img1_undistorted_img3_matches.npz'

    src_img2 = cv2.imread(f"./stitching/undistorted_img2.png")
    path_matches23 = './matches/undistorted_img2_undistorted_img3_matches.npz'

    src_img4 = cv2.imread(f"./stitching/undistorted_img4.png")
    path_matches43 = './matches/undistorted_img4_undistorted_img3_matches.npz'

    src_img5 = cv2.imread(f"./stitching/undistorted_img5.png")
