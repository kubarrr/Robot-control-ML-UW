...
# cv2.waitKey(0)
# cv2.destroyAllWindows()
cv2.imwrite(f"task5_stitched.png", stitched_img12)

############################
########## TASK 6 ########## 
############################

def calc_homography_based_on_match_pairs(src_img, path_matches):
...
H6=calc_homography_based_on_match_pairs(src_img6, path_matches98)
...
cv2.imwrite(f"task6_stitched.png", stitched98)
...
def stitch_5_images(dst_img,src_img1, src_img2, src_img4, src_img5, path_matches13, path_matches23, path_matches43, path_matches53):
    ...
    H13=calc_homography_based_on_match_pairs(src_img1, path_matches13)
    H23=calc_homography_based_on_match_pairs(src_img2, path_matches23)
    H43=calc_homography_based_on_match_pairs(src_img4, path_matches43)
    H53=calc_homography_based_on_match_pairs(src_img5, path_matches53)
